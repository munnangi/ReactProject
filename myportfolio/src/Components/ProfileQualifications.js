...
class ProfileQualifications extends React.Component {
  render() {
    return (
      <section>
        <ul >
          <Typography>
            ...
            <li>Active participation in requirement gathering, analyzing specifications and designing the project.</li>
            <li> Adept in working with a multi-disciplinary team to convert business needs into technical specifications.</li>
            <li>Well versed with Software Development Life Cycle <b>(SDLC)</b> process which includes requirement analysis, design, development, testing and implementation.</li>
          </Typography>
        </ul>
      </section>
    );
